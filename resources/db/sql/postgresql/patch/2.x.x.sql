ALTER TABLE domini ADD COLUMN avvisi_digitali BOOLEAN NOT NULL DEFAULT FALSE;
...
(
	...
	data_scadenza_pagamento DATE NOT NULL, -- Deve essere la stessa del versamento
	data_scadenza_avviso DATE NOT NULL,
