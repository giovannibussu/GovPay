...
import it.govpay.orm.dao.IDBAvvisoDigitaleEsitoServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.AvvisoDigitaleEsito} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCAvvisoDigitaleEsitoServiceSearch implements IDBAvvisoDigitaleEsitoServiceSearch, IDBServiceUtilities<AvvisoDigitaleEsito> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<AvvisoDigitaleEsito, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCAvvisoDigitaleEsitoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAvvisoDigitaleEsitoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("avvisoDigitaleEsito");
	...
	@Override
	public void validate(AvvisoDigitaleEsito avvisoDigitaleEsito) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(avvisoDigitaleEsito, this.log, 
	...
	@Override
	public List<AvvisoDigitaleEsito> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AvvisoDigitaleEsito> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public AvvisoDigitaleEsito find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AvvisoDigitaleEsito find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AvvisoDigitaleEsito get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AvvisoDigitaleEsito get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
