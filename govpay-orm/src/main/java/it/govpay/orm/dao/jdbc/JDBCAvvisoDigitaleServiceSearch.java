...
import it.govpay.orm.dao.IDBAvvisoDigitaleServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.AvvisoDigitale} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCAvvisoDigitaleServiceSearch implements IDBAvvisoDigitaleServiceSearch, IDBServiceUtilities<AvvisoDigitale> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<AvvisoDigitale, IdAvvisoDigitale, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCAvvisoDigitaleServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAvvisoDigitaleServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("avvisoDigitale");
	...
	@Override
	public void validate(AvvisoDigitale avvisoDigitale) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(avvisoDigitale, this.log, 
	...
	@Override
	public IdAvvisoDigitale convertToId(AvvisoDigitale obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+AvvisoDigitale.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public AvvisoDigitale get(IdAvvisoDigitale id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AvvisoDigitale get(IdAvvisoDigitale id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdAvvisoDigitale id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdAvvisoDigitale> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdAvvisoDigitale> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AvvisoDigitale> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AvvisoDigitale> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public AvvisoDigitale find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AvvisoDigitale find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdAvvisoDigitale id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdAvvisoDigitale id, AvvisoDigitale obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, AvvisoDigitale obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdAvvisoDigitale.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+AvvisoDigitale.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public AvvisoDigitale get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AvvisoDigitale get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdAvvisoDigitale findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdAvvisoDigitale id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
